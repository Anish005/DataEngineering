# aggregating user traffic per minute and writing to BQ
'''
create a new pipeline called batch_minute_traffic. It expands on the 
basic batch analysis principles used in batch_user_traffic and, 
instead of aggregating 
by users across the entire batch, aggregates by when events occurred
'''
